...
type PersistentVolumeClaimVolumeSource = kubeapi.PersistentVolumeClaimVolumeSource
type PersistentVolume = kubeapi.PersistentVolume
type PersistentVolumeClaim = kubeapi.PersistentVolumeClaim
...
type NFSVolumeSource = kubeapi.NFSVolumeSource
type CSIPersistentVolumeSource = kubeapi.CSIPersistentVolumeSource
